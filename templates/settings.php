<div class="wrap">
	<h2>Opening Times for your homepage!</h2>
	<div>
			...
			<tbody><tr>
                    ...
                    <td style="vertical-align: top; padding-left: 45px;" rowspan="5">
                        ...
                        <div class="backgroundStyle" style="background: #C7E0FF; color:#000000;" id="oe-searchwidget">
							<div style="background: #489BFF; color:#FFFFFF;" id="oe-searchwidget-title">Search Opening Times</div>
							<iframe width="150" height="200" frameborder="0" id="previewWidget" style="overflow: hidden;" src="http://www.all-opening-times.co.uk/rpc/widget/widget.php?wo=&amp;was=&amp;textcolor=000000&amp;textbgcolor=C7E0FF&amp;buttoncolor=FFFFFF&amp;buttonbgcolor=489BFF"></iframe>
...
<script type="text/javascript">
	...
	function regenerateURL() {
		...
		var url = "http://www.all-opening-times.co.uk/rpc/widget/widget.php?wo="+widgetwo+"&was="+widgetwas+"&textcolor="+textcolor+"&textbgcolor="+textbgcolor+"&buttoncolor="+buttoncolor+"&buttonbgcolor="+buttonbgcolor;
		return url;
	}
</script>